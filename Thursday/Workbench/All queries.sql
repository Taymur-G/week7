...
-- DELETE FROM movies;
-- DELETE FROM actor;
-- DELETE FROM movies WHERE row_count=10;
-- DELETE FROM actor WHERE row_count=10;

-- UPDATE movies SET actor='Test' WHERE movie_id=1;

-- CREATE TABLE IF NOT EXISTS movies(
-- movie_id integer unique auto_increment primary key,
...
-- actor_id integer unique auto_increment NOT NULL,
-- actor text NOT NULL,
-- foreign key(actor_id) REFERENCES movies(movie_id)
-- );

-- INSERT INTO movies(movie_name, actor, rating, genre) VALUES(
-- 'Spiderman',
-- 'Tom Holland',
-- 7.1,
-- 'N/A'
...
-- INSERT INTO actor(actor) VALUES('Dwayne Johnson');
...
-- SELECT * FROM movies WHERE actor='Tom Holland';
-- SELECT * FROM actor WHERE actor='Dwanye Johnson';
